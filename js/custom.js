...
$(document).ready(function() {
  $("#techwala, #presidwala, #sportswala, #acadwala, #cultwala, #contact, #news, #advisors, #stuwelfare, #tenders, #gallery, #products, #web_apps").hide();
    $("#tech").click(function() {
